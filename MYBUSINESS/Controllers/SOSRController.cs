...
namespace MYBUSINESS.Controllers
{
    ...
    public class SOSRController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (sOD != null)
                {
                    ...
                    foreach (SOD sod in sOD)
                    {
                        ...
                        //dont do this uneessary and sacary
                ...
                SOId = string.Join("-", ASCIIEncoding.ASCII.GetBytes(Encryption.Encrypt(sO.Id, "ABCD")));
        ...
        //{
        //    SOId = Encryption.Decrypt(SOId, "ABCD");
        //    string pathh = HttpRuntime.AppDomainAppPath;
        //    ReportDocument reportDocument = new ReportDocument();
        ...
        public ActionResult Edit(string id, bool update)
        {
            ...
            sO.Id = Encryption.Encrypt(sO.Id, "ABCD");
        ...
        public ActionResult Edit(SaleOrderViewModel saleOrderViewModel1)
        {
            ...
            if (ModelState.IsValid)
            {
                newSO.Id = Encryption.Decrypt(saleOrderViewModel1.SaleOrder.Id, "ABCD");//
