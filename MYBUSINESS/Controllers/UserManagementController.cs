...
namespace MYBUSINESS.Controllers
{
    public class UserManagementController : Controller
    {
        ...
        //public ActionResult Login(Employee emp, Right right)
        {
            ...
            string unl= Encryption.Decrypt("089CdIWvdVE=", "ABC");//abc123

            if (emp.Password == null) { emp.Password = string.Empty; }
            emp.Password = Encryption.Encrypt(emp.Password, "ABC");
            ...
            if (user != null)
            {
                ...
                return RedirectToAction("Index", "Dashboard1",new {IsReturn="false" });//change it from 'if condtion' to here
