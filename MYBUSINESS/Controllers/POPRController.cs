...
namespace MYBUSINESS.Controllers
{
    public class POPRController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //pOes.ForEachAsync(m => m.Id = Encryption.Encrypt(m.Id, "ABCD"));
        ...
        public ActionResult SearchProduct(int productId)
        {
            ...
            //sOes.ForEachAsync(m => m.Id = Encryption.Encrypt(m.Id, "ABCD"));
...

        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string POId = string.Join("-", ASCIIEncoding.ASCII.GetBytes(Encryption.Encrypt(pO.Id, "ABCD")));
                //return PrintSO(POId);
        ...
        //{
        //    POId = Encryption.Decrypt(POId, "ABCD");
        //    string pathh = HttpRuntime.AppDomainAppPath;
        //    ReportDocument reportDocument = new ReportDocument();
        ...
        public ActionResult Edit(PurchaseOrderViewModel purchaseOrderViewModel1)
        {
            ...
            if (ModelState.IsValid)
            {
                newPO.Id = Encryption.Decrypt(purchaseOrderViewModel1.PurchaseOrder.Id, "ABCD");//
        ...
        public ActionResult Edit(string id, bool update)
        {
            ...
            pO.Id = Encryption.Encrypt(pO.Id, "ABCD");
